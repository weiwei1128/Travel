        ...
        okTxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!nameEdt.getText().toString().equals(name)
                        ...
                        || !addrEdt.getText().toString().equals(addr)&& finalAccount !=null) {
                    //資料已更新!
                    ...
                    long result = database.update("member", cv, "account=?", new String[]{finalAccount});
                    Functions.toast(MemberEditActivity.this,MemberEditActivity.this.getString(R.string.editok_text));
